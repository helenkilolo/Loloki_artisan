...
export async function getServerSideProps() {
  ...
  return {
    props: {
      ...
      categories: ['Dresses', 'Shorts', 'Trousers'], // Example subcategories
    },
  };
}

export default function WomenPage({ initialProducts, categories }) {
    ...
    <>
      <div className="container mx-auto flex">
        ...
        <div className="flex-1">
          <h1 className="text-4xl font-bold mb-8">Women</h1>
