...
export async function getServerSideProps() {
  ...
  const products = await productsCollection.find({ category: 'Shoes' }).toArray();
  client.close();
  ...
  return {
    props: {
      ...
      categories: ['Sneakers', 'Boots', 'Sandals'], // Example subcategories
    },
  };
}

export default function ShoesPage({ initialProducts, categories }) {
