...
export async function getServerSideProps() {
  ...
  // Fetch products in the 'Accessories' category
  const products = await productsCollection.find({ category: 'Accessories' }).toArray();
  client.close();
  ...
  return {
    props: {
      ...
      categories: ['Hats', 'Scarves', 'Belts'], // Example subcategories
    },
  };
}

export default function AccessoriesPage({ initialProducts, categories }) {
